private function generate_form_html($form, $atts = array()) {
        ...
        $custom_styles = $this->build_form_custom_styles($customization);
        ...
        $html .= $this->render_captcha_html($captcha);
        $html .= $this->render_submit_button_html($button_style);
    ...
    private function build_form_custom_styles($customization) {
        $custom_styles = '';
    ...
    private function render_captcha_html($captcha) {
    ...
    private function render_submit_button_html($button_style) {
